...
def main(args=None):
    ...
    parser.add_argument('--coco_path', help='Path to COCO directory', default=r'.\coco2017')
    parser.add_argument('--model_path', help='Path to model', type=str, default=r'.\results\teacher_model\coco_retinanet_10.pt')
